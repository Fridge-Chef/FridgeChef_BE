...
public class IngredientServiceTest {
    ...
    void extract_ingredient_names() {
        ...
        List<RecipeIngredient> result1 = ingredientService.extractIngredients(ingredient1);

        assertThat(result1).extracting("ingredient.name").containsExactly("새우두부계란찜", "연두부", "칵테일새우", "달걀", "생크림", "설탕", "무염버터", "고명", "시금치");
        assertThat(result1).extracting("quantity")
                .containsExactly("X", "75g(3/4모)", "20g(5마리)", "30g(1/2개)", "13g(1큰술)", "5g(1작은술)", "5g(1작은술)", "X", "10g(3줄기)");
        ...
        List<RecipeIngredient> result2 = ingredientService.extractIngredients(ingredient2);
        ...
        List<RecipeIngredient> result3 = ingredientService.extractIngredients(ingredient3);
        ...
        List<RecipeIngredient> result4 = ingredientService.extractIngredients(ingredient4);
        ...
        List<RecipeIngredient> result5 = ingredientService.extractIngredients(ingredient5);
        ...
        List<RecipeIngredient> result6 = ingredientService.extractIngredients(ingredient6);
        ...
        List<RecipeIngredient> result7 = ingredientService.extractIngredients(ingredient7);
        ...
        List<RecipeIngredient> result8 = ingredientService.extractIngredients(ingredient8);
        ...
        List<RecipeIngredient> result9 = ingredientService.extractIngredients(ingredient9);
