...
public class DumpServiceTest {
    ...
    void extract_ingredient_names() {
        ...
        List<RecipeIngredient> result1 = dumpService.extractIngredients(ingredient1);
        ...
        List<RecipeIngredient> result2 = dumpService.extractIngredients(ingredient2);
        ...
        List<RecipeIngredient> result3 = dumpService.extractIngredients(ingredient3);
        ...
        List<RecipeIngredient> result4 = dumpService.extractIngredients(ingredient4);
        ...
        List<RecipeIngredient> result5 = dumpService.extractIngredients(ingredient5);
        ...
        List<RecipeIngredient> result6 = dumpService.extractIngredients(ingredient6);
        ...
        List<RecipeIngredient> result7 = dumpService.extractIngredients(ingredient7);
        ...
        List<RecipeIngredient> result8 = dumpService.extractIngredients(ingredient8);
        ...
        List<RecipeIngredient> result9 = dumpService.extractIngredients(ingredient9);
